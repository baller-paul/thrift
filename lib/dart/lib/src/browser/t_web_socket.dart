...
class TWebSocket implements TSocket {
  ...
  final StreamController<TSocketState> _onStateController = StreamController.broadcast();
  @override
  Stream<TSocketState> get onState => _onStateController.stream;

  final StreamController<Object> _onErrorController = StreamController.broadcast();
  @override
  ...
  void _onMessage(MessageEvent message) {
    try {
      Uint8List data = Uint8List.fromList(base64.decode(message.data as String));
